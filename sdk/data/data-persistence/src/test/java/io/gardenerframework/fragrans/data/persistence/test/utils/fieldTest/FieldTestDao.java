...
import io.gardenerframework.fragrans.data.persistence.orm.statement.schema.statement.StatementCharSequenceAdapter;
    ...
    class CommonScannerCallbacks {
        ...
        public static class SelectStatementIgnoredAnnotations implements BiFunction<FieldScanner, Class<?>, Collection<String>> {
            ...
            public Collection<String> apply(FieldScanner fieldScanner, Class<?> aClass) {
                return fieldScanner.columns(aClass, Collections.singletonList(SkipInGenericReadOperation.class), false);
            }
        }
        ...
        public static class UpdateStatementIgnoredAnnotations implements BiFunction<FieldScanner, Class<?>, Collection<String>> {
            ...
            @Override
            public Collection<String> apply(FieldScanner fieldScanner, Class<?> aClass) {
                return fieldScanner.columns(aClass, Arrays.asList(ImmutableField.class, DatabaseControlledField.class, SkipInGenericUpdateOperation.class), false);
            }
        }
    }
}
