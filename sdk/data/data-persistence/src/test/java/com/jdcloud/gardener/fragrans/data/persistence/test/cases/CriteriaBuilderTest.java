...
import com.jdcloud.gardener.fragrans.data.persistence.criteria.annotation.Equals;
import com.jdcloud.gardener.fragrans.data.persistence.criteria.support.CriteriaBuilder;
...
public class CriteriaBuilderTest {
    ...
    public void smokeTest() {
        Map<Class<?>, BasicCriteria> test = criteriaBuilder.createCriteriaTraitMapping(
                null,
                TestEntity.class,
                new TestCriteria(),
                "test"
        );
        BasicCriteria basicCriteria = test.get(GenericTraits.IdentifierTraits.Id.class);
        //没有任何搜索值，条件被忽略
