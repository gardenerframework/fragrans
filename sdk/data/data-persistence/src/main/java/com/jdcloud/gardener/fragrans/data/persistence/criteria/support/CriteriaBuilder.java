...
import com.jdcloud.gardener.fragrans.data.persistence.criteria.annotation.CriteriaProvider;
...
import com.jdcloud.gardener.fragrans.sugar.trait.utils.TraitUtils;
...
public class CriteriaBuilder {
    ...
    public <E, C> MatchAllCriteria createCriteria(
        ...
        Map<Class<?>, BasicCriteria> criteriaTraitMapping = createCriteriaTraitMapping(tableName, entityType, criteria, criteriaParameterName, filter);
        ...
        if (!CollectionUtils.isEmpty(must)) {
            ...
            must.forEach(
                    trait -> {
                        BasicCriteria basicCriteria = criteriaTraitMapping.get(trait);
     ...
     * @return 映射
     */
    public <E, C> Map<Class<?>, BasicCriteria> createCriteriaTraitMapping(
            @Nullable String tableName,
            @NonNull Class<E> entityType,
            @NonNull C criteria,
            @NonNull String criteriaParameterName
    ...
    public <E, C> Map<Class<?>, BasicCriteria> createCriteriaTraitMapping(
        ...
        Map<Class<?>, BasicCriteria> mapping = new HashMap<>();
        //获取接口实现的所有traits
        ...
        traits.forEach(
                trait -> {
                    ...
                    try {
                        ...
                        //查看是否是批量操作
                        BasicCriteria criteriaCreated = null;
                        //判断集合逻辑
