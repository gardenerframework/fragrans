package com.jdcloud.gardener.fragrans.api.standard.error.test.cases;

import com.jdcloud.gardener.fragrans.api.standard.error.configuration.ApiErrorRegistry;
import com.jdcloud.gardener.fragrans.api.standard.error.test.ApiStandardErrorRevealTestApplication;
import com.jdcloud.gardener.fragrans.api.standard.error.test.cases.exception.annotation.hide.AnnotationHideEx1;
import com.jdcloud.gardener.fragrans.api.standard.error.test.cases.exception.annotation.hide.AnnotationHideEx2;
import com.jdcloud.gardener.fragrans.api.standard.error.test.cases.exception.annotation.hide.ShouldHideEx;
import com.jdcloud.gardener.fragrans.api.standard.error.test.cases.exception.annotation.hide.ShouldRevealEx;
import com.jdcloud.gardener.fragrans.api.standard.error.test.cases.exception.annotation.revealed.AnnotationRevealedEx1;
import com.jdcloud.gardener.fragrans.api.standard.error.test.cases.exception.annotation.revealed.AnnotationRevealedEx2;
import com.jdcloud.gardener.fragrans.api.standard.error.test.cases.exception.base.hide.BaseClassHideEx1;
import com.jdcloud.gardener.fragrans.api.standard.error.test.cases.exception.base.hide.BaseClassHideEx2;
import com.jdcloud.gardener.fragrans.api.standard.error.test.cases.exception.base.revealed.BaseClassRevealedEx1;
import com.jdcloud.gardener.fragrans.api.standard.error.test.cases.exception.base.revealed.BaseClassRevealedEx2;
